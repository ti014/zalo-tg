...
- `product/overview.md`: current product contract for the Zalo–Telegram bridge.
- `operations.md`: production deployment, health, queue, backup, restore, and
  recovery runbook.
- `../README.md`: bilingual onboarding guide, configuration reference, and
